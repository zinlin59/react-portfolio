                ...
                <section className="text-gray-200 ">
                    <div className="max-w-6xl mx-auto px-5 py-16 ">
                        ...
                        <div className="text-center mb-20">
                            <h1 className=" title-font text-gray-700  mb-4 text-4xl font-extrabold leading-10 tracking-tight sm:text-5xl sm:leading-none md:text-6xl">What Skills I Have</h1>
                            <p className="text-base leading-relaxed text-gray-700 text-3xl mx-auto">&lt; Front-End Development Skills /&gt;</p>
                        ...
                        <div className="flex  flex-wrap justify-center sm:-m-4 -mx-4 -mb-10 -mt-4 cardrow">
                            <Flip left>
                                <div className="p-10 sm:w-1/3   md:w-1/3 md:mb-0 mb-6 flex flex-col skillcard">
                                    <div className="pattern-dots-lg gray-light dotted">
                        ...
                        <div className="text-center mb-20 pt-16 ">
                            <p className="text-base leading-relaxed text-gray-700 text-3xl mx-auto">&lt; Back-End Development Skills /&gt;</p>
                            <div className="flex mt-6 justify-center">
                                <div className="w-24 h-1 rounded-full bg-indigo-500 inline-flex"></div>
                            </div>
                        </div>
